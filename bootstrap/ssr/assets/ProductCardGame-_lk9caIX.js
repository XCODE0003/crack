    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Link), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-center items-center"${_scopeId}><img class="w-16 rounded-lg h-16"${ssrRenderAttr("src", "/storage/" + __props.product.image)}${_scopeId}></div><div class="flex items-center flex-col gap-1"${_scopeId}><p class="leading-none font-medium"${_scopeId}>${ssrInterpolate(__props.product.title)}</p><div class="flex items-center specification gap-2"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "flex justify-center items-center" }, [
                createVNode("img", {
                  class: "w-16 rounded-lg h-16",
                  src: "/storage/" + __props.product.image
                }, null, 8, ["src"])
              ]),
              createVNode("div", { class: "flex items-center flex-col gap-1" }, [
